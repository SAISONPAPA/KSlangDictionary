...
| **Google Analytics (GA4)** | Measurement ID `G-F475ZTL1ZV`, embedded in every page's `<head>` (main 5 pages + all `word/*.html`, via `GA_ID` constant near the top of `scripts/generate_word_pages.py`) |
